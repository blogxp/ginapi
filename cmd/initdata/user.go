...
func InitSysUsers(db *gorm.DB) {
	...
	*status = 1
	...
	var Users = []models.SysUser{
		{Model: models.Model{ID: 1, CreatedAt: models.XTime{time.Now()}, UpdatedAt: models.XTime{time.Now()}}, Name: "admin", Password: "e64b78fc3bc91bcbc7dc232ba8ec59e0", RealName: "超级管理员", Status: status, Type: 2},
